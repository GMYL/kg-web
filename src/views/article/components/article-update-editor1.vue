        ...
        <Row>
            <i-col span="18">
                <Card :bordered="false" :dis-hover="true">
                    ...
                    <quill-editor v-model="data.content" ref="myQuillEditor" ></quill-editor>
                </Card>
            </i-col>
  ...
  export default {
    ...
    computed: {
      ...
      data() {
          ...
          //此编辑器不识别“ ”所以替代
          if(typeof this.srcdata.content != 'undefined'){
              this.srcdata.content = this.srcdata.content.replaceAll(' ', "&nbsp;");
          }
      ...
      handlePublish() {
        if (this.canPublish()) {
          this.publishLoading = true;
            sessionStorage.articleUpdateTextCache = this.data.content;
