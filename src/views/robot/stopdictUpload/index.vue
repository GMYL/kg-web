  ...
  export default {
            ...
            return h('div', [
              h('Button', {
                ...
                style: {
                  ...
                  on: {
                      click: () => {
                          this.$http.delete('/excel/stopdict/' + params.row.id).then(() => {
                              this.$Notice.success({
                                  title: '删除成功'
                              });
                              this.getFresh();
    ...
    methods: {
      ...
      handleSelectDel () {
        ...
        this.$http.post('/excel/lawannex/confirm', head).then(res => {
          this.$Notice.error({
            title: '删除成功'
          });
          this.getFresh();
      ...
      handleSelectSubmit () {
        ...
        this.$http.post('/excel/stopdict/confirm', postMsg).then(res => {
          this.$Notice.success({
            title: '上传成功'
          });
          this.getFresh();
      ...
      upload () {
        ...
        if (this.type) {
          ...
          this.$http.post('/excel/stopdict/upload', formData, config).then(res => {
      ...
      getFresh () {
          //  获取临时预览的文件
        this.$http.post('/excel/stopdict/query', this.$data.filterData).then(res => {
