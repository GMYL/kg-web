...
<template>
    <div class="main" :class="{'main-hide-text': shrink}">
        ...
        <div class="main-header-con" :style="{paddingLeft: shrink?'60px':'200px', height: 'initial'}">
            <div class="main-header" style="margin-left: 4px;">
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        shrink: false,
        iWidth: '200px', //  定义width 传递给子组件
        isFullScreen: false,
        openedSubmenuArr: this.$store.state.app.openedSubmenuArr,
        userName: this.$store.state.user.user.nickName
          ? '欢迎：' + this.$store.state.user.user.nickName
    ...
    methods: {
      ...
      toggleClick() {
        ...
        this.iWidth = this.shrink ? '100%' : '182px'; //  更改子组件的width值
      },
